...
4. Model preference for initial prototypes: **claude-fable-5 (Fable 5)**.
5. Open **one PR**. Attach **both** at least one screenshot **and** at least one video of the running app in the PR body (validation artifacts). Not optional.
6. Keep the MVP single-user and demable in one sitting.
